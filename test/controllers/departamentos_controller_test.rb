...
class DepartamentosControllerTest < ActionController::TestCase
  ...
  test "should create departamento" do
    assert_difference('Departamento.count') do
      post :create, departamento: { departamento: @departamento.departamento, provincia_id: @departamento.provincia_id }
    end
  ...
  test "should update departamento" do
    patch :update, id: @departamento, departamento: { departamento: @departamento.departamento, provincia_id: @departamento.provincia_id }
    assert_redirected_to departamento_path(assigns(:departamento))
  end

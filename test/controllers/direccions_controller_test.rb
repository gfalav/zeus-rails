...
class DireccionsControllerTest < ActionController::TestCase
  ...
  test "should create direccion" do
    assert_difference('Direccion.count') do
      post :create, direccion: { acceso: @direccion.acceso, calle_id: @direccion.calle_id, nro: @direccion.nro, pdepto: @direccion.pdepto }
    end
  ...
  test "should update direccion" do
    patch :update, id: @direccion, direccion: { acceso: @direccion.acceso, calle_id: @direccion.calle_id, nro: @direccion.nro, pdepto: @direccion.pdepto }
    assert_redirected_to direccion_path(assigns(:direccion))
  end
